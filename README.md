...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d0d0d,100:1a1a2e&height=200&section=header&text=AbhhnavPundir&fontSize=70&fontColor=c9d1d9&fontAlignY=38&desc=design.%20code.%20obsession.&descAlignY=58&descSize=18&descColor=8b949e" width="100%"/>

[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=500&size=16&pause=1000&color=8B949E&center=true&vCenter=true&width=500&lines=BTech+CSE+%7C+AKTU;Python+%2B+Photoshop+%7C+Digital+Art;Learning+DSA+one+problem+at+a+time;Building+in+the+dark%2C+shipping+in+the+light)](https://git.io/typing-svg)
...
- 🦇 **Dark-themed digital art** — Batman concept work in Photoshop & Python (PIL/OpenCV)
- 🧠 **DSA grind** — Sigma 1.1 structured plan, arrays → trees → graphs
- 🎨 **Python × Art** — scripting visual effects, generative graphics
- 💪 **Discipline > motivation** — fitness + focus as a system
...
[![Gmail](https://img.shields.io/badge/Gmail-0d0d0d?style=for-the-badge&logo=gmail&logoColor=EA4335)](mailto:abhinavpundir0005@gmail.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0d0d0d?style=for-the-badge&logo=linkedin&logoColor=0A66C2)](https://linkedin.com/in/)
